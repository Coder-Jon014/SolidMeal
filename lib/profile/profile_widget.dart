                  ...
                  builder: (context) => Builder(
                    builder: (context) {
                      ...
                      return ListView.builder(
                        ...
                        itemCount: illnessesList.length,
                        itemBuilder: (context, illnessesListIndex) {
                          final illnessesListItem =
                              illnessesList[illnessesListIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                10.0, 10.0, 10.0, 10.0),
              ...
              Padding(
                ...
                child: StreamBuilder<List<UserFavoriteRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<UserFavoriteRecord> wrapUserFavoriteRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final wrapUserFavoriteRecord =
                        wrapUserFavoriteRecordList.isNotEmpty
                            ? wrapUserFavoriteRecordList.first
                            : null;
                    return Builder(
                      builder: (context) {
                        final favs = wrapUserFavoriteRecord!.recipeId!.toList();
                        return Wrap(
                          spacing: 8.0,
                          runSpacing: 8.0,
                          ...
                          children: List.generate(favs.length, (favsIndex) {
