    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<IllnessesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<IllnessesRecord> homeCopy2IllnessesRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final homeCopy2IllnessesRecord =
              homeCopy2IllnessesRecordList.isNotEmpty
                  ? homeCopy2IllnessesRecordList.first
                  : null;
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          homeCopy2IllnessesRecord!.illness!,
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                        Text(
                          homeCopy2IllnessesRecord!.targetSaturatedFat!
                              .toString(),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                        Text(
                          homeCopy2IllnessesRecord!.targetSodium!.toString(),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: RecipesCall.call(
                              maxSaturatedFat: homeCopy2IllnessesRecord!
                                  .targetSaturatedFat
                                  ?.toDouble(),
                              maxSugar: homeCopy2IllnessesRecord!.targetSugar
                                  ?.toDouble(),
                              maxSodium: homeCopy2IllnessesRecord!.targetSodium
                                  ?.toDouble(),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
