...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'KNNTrial',
          path: '/kNNTrial',
          builder: (context, params) => KNNTrialWidget(
            number: params.getParam('number', ParamType.int),
            maxSodium: params.getParam('maxSodium', ParamType.int),
            maxSugar: params.getParam('maxSugar', ParamType.int),
            maxSaturatedFat: params.getParam('maxSaturatedFat', ParamType.int),
          ),
        ),
        FFRoute(
          name: 'Onboarding',
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailsScreenWidget(
            ...
            recipeInfo: params.getParam('recipeInfo', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'MoreCuisine',
          path: '/moreCuisine',
          builder: (context, params) => MoreCuisineWidget(
